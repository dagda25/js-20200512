...
export default class SortableTable {
    ...
    constructor(headersConfig, {
      data = []
    } = {}, defaultSorting = {field: 'title', order: 'asc'}) {
      this.headersConfig = headersConfig;
      this.data = data;
      this.defaultSorting = defaultSorting;
  
      this.render();
      this.sort(defaultSorting.field, defaultSorting.order);
    ...
    initEventListeners() {
        this.subElements.header.addEventListener('click', (event) => {
            ...
            if (targetColumn) {
                targetColumn.dataset.order = targetColumn.dataset.order === 'desc' ? 'asc' : 'desc';
                this.sort(targetColumn.dataset.id, targetColumn.dataset.order);
            }
        })
    }
